            ...
            {                
                ...
                for (First_round=0; ; First_round++)
                {
                    ...
                    for(int Second_round=0; Second_round<1;)
                    {
                        ...
                        lambda[Count_Points - 1] = 0 + Null_lambda * Delta_border_T;
                        for (int i = Count_Points - 2; i > 0; i--)
                ...
                for (double k = Left_border; k < Right_border; k += 0.001)
                {
                    ...
                    chart1.Series[2].Points.AddXY(k, x_delta_T[First_round % 2, s] - Math.Pow(u_delta_T[First_round % 2, s], 2) + u_delta_T[First_round % 2, s] * lambda[s]);
